                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-3 h-8 pr-10 border rounded-md transition-colors ${errors.nuevaPassword ? 'border-red-300' : 'border-slate-300'
                                        }`}
                                    disabled={loading}
                            ...
                            {errors.nuevaPassword && (
                                <p className="text-red-600  mt-1">{errors.nuevaPassword}</p>
                            )}
                        </div>
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-md p-3">
                            <div className="flex items-start">
                                <div className="ml-3">
                                    <p className="text-slate-800 font-medium">Recomendaciones de Seguridad</p>
