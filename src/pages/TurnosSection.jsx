...
const TurnosSection = () => {
    ...
    // Renderizar estadísticas del sector
        ...
        return (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-blue-900">{estadisticas.colaActual}</p>
                        </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-yellow-600 text-sm font-medium">Llamados</p>
                            <p className="text-2xl font-bold text-yellow-900">{estadisticas.llamados}</p>
                        </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-green-600 text-sm font-medium">En Atención</p>
                            <p className="text-2xl font-bold text-green-900">{estadisticas.enAtencion}</p>
                        </div>
                        <PlayArrow className="h-8 w-8 text-green-600" />
                    </div>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-gray-600 text-sm font-medium">Finalizados</p>
                            <p className="text-2xl font-bold text-gray-900">{estadisticas.finalizados}</p>
                        </div>
